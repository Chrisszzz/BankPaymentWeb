...
<head>
    ...
    <style>
        ...
        .card-form img {
            margin-bottom: 30px;
            /* Tambahkan jarak antara logo dan form */
            display: block;
            margin-left: auto;
            margin-right: auto;
        }
...
<body>
    ...
    <div class="card">
        ...
        <!-- Bagian Form Login -->
        <div class="card-form">
            <img src="https://minang.geoparkrun.com/wp-content/uploads/2022/11/bca-logo.png" alt="Logo"
                width="120px">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button class="btn btn-secondary toggle-password" type="button">
                                <span id="toggle-password-icon" class="glyphicon glyphicon-eye-open"></span>
                            </button>
                        </span>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('.toggle-password').on('click', function() {
            ...
            let passwordIcon = $('#toggle-password-icon');
